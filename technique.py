...
material = df['technique'].to_list() # make list of all techniques

label = [] # will contain numerical representaion of techniques
l = list(set(material)) # словарь

for i in material:
    label.append(l.index(i)) # each techniques will equal its index in dict
...
model.save("E:\\models\\technique_model.h5")
